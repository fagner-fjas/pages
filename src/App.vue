...
import sgeduIcon from './assets/sgedu-icon.png'
import appleIcon from './assets/icons8-ios-100.png'
...
const currentDocument = documents[currentPath]
...
<template>
  <main v-if="currentDocument" class="legal-page">
    <header class="legal-hero">
      <a class="brand-link" href="/" aria-label="Voltar para a página inicial da FJAS TI">
        <img :src="fjasLogo" alt="FJAS TI" />
      </a>
      <p class="eyebrow">{{ currentDocument.eyebrow }}</p>
      <h1>{{ currentDocument.title }}</h1>
      <p class="legal-subtitle">{{ currentDocument.subtitle }}</p>
      <div class="legal-meta">
        <span>SGEdu Escola</span>
        <span>SGEdu Aluno</span>
        <span>Atualizado em {{ currentDocument.updatedAt }}</span>
      </div>
    </header>

    <article class="legal-document" :aria-labelledby="currentDocument.slug">
      ...
      <section class="intro-section">
        <p v-for="paragraph in currentDocument.intro" :key="paragraph">
          {{ paragraph }}
        </p>
      </section>
    ...
    <footer class="legal-footer">
      <button type="button" @click="goHome">Voltar para FJAS TI</button>
  ...
  <main v-else class="home-page">
    ...
    <section class="home-grid" aria-label="Links principais">
      <div class="home-panel">
        <h2>SGEdu</h2>
        <p>Sistema para gestão educacional.</p>
        <ul class="action-links">
          <li>
            <a href="https://sgedu.com.br/" target="_blank" rel="noreferrer">
              <img :src="sgeduIcon" alt="" />
              Web
            </a>
          </li>
          <li>
            <a
              href="https://play.google.com/store/apps/details?id=br.com.sgedu&pcampaignid=web"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://apps.apple.com/br/app/sgedu-aluno/id6745787998"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div class="home-panel">
        ...
        <p>Nos envie um e-mail ou mensagem pelo WhatsApp.</p>
        <ul class="action-links">
          <li>
            <a href="mailto:contato@fjas.com.br">contato@fjas.com.br</a>
          </li>
          <li>
            <a href="https://w.app/ui0drq" target="_blank" rel="noreferrer">
    ...
    <footer class="home-legal">
      <nav aria-label="Documentos legais do SGEdu">
        <a v-for="link in legalLinks" :key="link.href" :href="link.href">
          {{ link.label }}
        </a>
      </nav>
